...
from scope_state import AgentInputState,AgentState,ClarifyWithUser,ResearchQuestion
...
def write_research_brief(state: AgentState):
    ...
    and ontains all necessary details for effective research.
    """
    # Set up structured output model
...
app=deep_research_builder.compile()
